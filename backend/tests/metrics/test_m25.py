...
"""
Tests for the 'Number of Vertical Block Sizes' metric (m25).
"""
...
from aim.metrics.m25.m25_num_vertical_block_sizes import Metric
...
@pytest.mark.parametrize(
    ...
    [
        ("interfacemetrics_aalto.png", [18, 14]),
        ("white.png", [0, 0]),
    ],
)
def test_num_vertical_block_sizes_desktop(
    input_value: str, expected_results: List[Any]
) -> None:
    """
    Test Number of Vertical Block Sizes (desktop GUIs).
