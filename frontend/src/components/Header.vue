      ...
      <b-col class="text-right">
        <b-row>
          <b-col cols="12" class="col-lg-auto ml-auto text-right">
            <b-btn class="btn-nav btn-lg" href="mailto:interfacemetrics@aalto.fi?subject=Aalto%20Interface%20Metrics%3A%20Feedback" variant="link font-weight-bold">Contact</b-btn>
          </b-col>
            ...
            <b-modal id="modal-project" class="text-left" size="lg" title="Project" ok-only ok-title="Close">
              <b-row>
                <b-col class="col-xs-12">
                  ...
                  <h6>Contributors</h6>
                  <p>
                    Antti Oulasvirta, Samuli De Pascale, Janin Koch, Thomas Langerak, Jussi Jokinen, Kashyap Todi, Markku Laine, Manoj Kristhombuge, Yuxi Zhu, Aliaksei Miniukovich, Gregorio Palmas, Tino Weinkauf, Ai Nakajima, Valentin Ionita, Morteza Shiripour, Amir Hossein Kargaran, Chuhan Jiao, and Nafiseh Nikeghbal.
                  </p>
                </b-col>
              </b-row>
            </b-modal>
